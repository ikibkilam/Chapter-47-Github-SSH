// In this chapter, we shall git version control. I have removed the comments created in Chapter 41, 
// Chapter 42, Chapter 43, Chapter 44, Chapter 45 and Chapter 46, for readability.

// Please see Notes.txt, for installing and running git. Note, at first all folders and files were not
// tracked. We chose to track server.js, views folder, public folder, package.json, package-lock.json.
// Server.log need not be tracked, since it is peritnent only at that moment in time. Node_moudles 
// need not be tracked, since it can be generated by running 'npm install' in the parent folder.
